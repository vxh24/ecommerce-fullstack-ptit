            ...
            <div className="col-7">
              <div className="checkout-left-data">
                  ...
                  <div className="d-flex flex-column gap-15 py-3 ps-3 bg-white mb-4">
                    ...
                    <div className="w-30">
                      <button
                        ...
                        className="button-checkout1 text-dark"
                      >
                        Đóng
                      </button>
                    </div>
                  ...
                  <div className="mb-3">
                    ...
                    <div className="form-check">
                      ...
                      <label
                        ...
                        for="flexRadioDefault2"
                      >
                        Giao hàng tiết kiệm - {formatPrice(20000)}
                      </label>
                    </div>
                  </div>
                </div>
                <div className="mt-3 d-flex gap-30 mb-3 py-3">
                  ...
                  <div className="d-flex align-items-center gap-10">
                    <p className="mb-0 voucher" onClick={handleShow}>
                      Chọn hoặc nhập mã
                    </p>
                  </div>
                  {coupon && (
                ...
                {userCartState?.products &&
                  userCartState?.products?.map((item, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="d-flex mb-2 gap-15 align-items-center justify-content-between border-bottom mb-3"
                      >
              ...
              <div className="d-flex mt-3 justify-content-between mb-3 border-bottom">
                ...
                <div className="ps-3">
                  <div className="d-flex gap-10 align-items-center mb-2">
                    ...
                    <p className="price mb-0">{formatPrice(totalAmount)}</p>
                  </div>
                  <div className="d-flex gap-10 align-items-center mb-2">
                    <strong>Tổng giảm giá:</strong>{" "}
                    <p className="price mb-0">
                      {coupon ? formatPrice(totalcoupon) : formatPrice(0)}
                    </p>
                  </div>
                  <div className="d-flex gap-10 align-items-center mb-2">
                    <strong>Tổng phí vận chuyển:</strong>{" "}
                    <p className="price mb-0">{formatPrice(shipping)}</p>
                  </div>
                  <p className="price">
