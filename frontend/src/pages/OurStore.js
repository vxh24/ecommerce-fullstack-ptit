...
import { searchProductSlice } from "../features/products/productSlice";
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://localhost:5000/v1/api/product?${finalQuery}`
      );
              ...
              <div className="filter-card mb-3">
                ...
                <div>
                  ...
                  <div className="d-flex align-items-center mt-3 justify-content-center">
                    <button
                      className="button-filter form-control"
